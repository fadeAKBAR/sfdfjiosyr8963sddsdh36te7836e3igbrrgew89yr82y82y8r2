  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-[#1A1A1A] font-sans selection:bg-[#FE2C55] selection:text-white pb-16">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 pt-6 sm:pt-8">
        ...
        <div className="mb-6 p-4 rounded-2xl bg-white border border-gray-100 flex items-center justify-between gap-3 shadow-xs">
          ...
          <button
            ...
            className="shrink-0 text-xs font-bold text-[#10B981] hover:text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 px-3.5 py-2 rounded-xl transition cursor-pointer"
          >
            Top Up USD
          </button>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 text-xs text-gray-500 space-y-2 text-center sm:text-left">
          <div className="flex items-center justify-center sm:justify-start gap-2 text-gray-700 font-bold">
